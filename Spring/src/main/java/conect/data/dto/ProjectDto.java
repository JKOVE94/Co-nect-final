...
public class ProjectDto {
    ...
    private LocalDate proj_startdate; // 프로젝트 시작일 [DATETIME]
    private LocalDate proj_enddate; // 프로젝트 종료일 [DATETIME]
    ...
    private LocalDate proj_created; // 프로젝트 생성 일시 [DATETIME]
    private LocalDate proj_updated; // 프로젝트 정보 최종 수정 일시 [DATETIME]
    ...
    private int proj_temp; // 프로젝트 임시저장
    ...
    public static ProjectDto fromEntity(ProjectEntity entity) {
        ...
        dto.setProj_userMail(entity.getUserEntity().getUserMail());
