...
import { debounce } from 'lodash';
    ...
    const renderProjectRows = () => {
        if (loading) return (
            <tr>
                <td colSpan="7" className="text-center">로딩 중...</td>
            </tr>
        );
        ...
        return projects.slice(0,8).map((project, index) => (
            <tr key={project.proj_pk_num || index} style={{ width: '100%', overflowX: 'hidden' }}>
                ...
                <td className="text-truncate" style={{ maxWidth: '150px' }}>{project.proj_name}</td>
                <td className="text-truncate" style={{ maxWidth: '200px' }}>{project.proj_desc}</td>
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <div className="progress-container">
                            <Progress
                                ...
                                barClassName={`bg-${project.proj_progress === 100 ? 'success' : 'danger'}`}
                            />
                        </div>
                    </div>
                </td>
                <td className="text-right">
                    <UncontrolledDropdown>
                        ...
                        <DropdownMenu right>
                            <DropdownItem onClick={() => handleEditProject(project.proj_pk_num)}>수정</DropdownItem>
                            <DropdownItem onClick={() => handleDeleteProject(project.proj_pk_num)}>삭제</DropdownItem>
                        </DropdownMenu>
                    </UncontrolledDropdown>
                </td>
            </tr>
                ...
                <Row >
                    <Col>
                        ...
                        >
                            ...
                            >
                                <h1 className="mb-0" style={{ flex: '1 0 auto', marginRight: '20px' }}>프로젝트 목록</h1>
                                <div
                                    className="d-flex align-items-center"
                                    style={{
                                        flex: '0 1 auto',
                            ...
                            >
                                <Table style={{ width: '100%', overflowX: 'visible'}}>
                                    <thead>
                                    <tr>
                                        <th className="text-center" style={{ width: '10%' }}>즐겨찾기</th>
                                        <th style={{ width: '20%' }}>프로젝트</th>
                                        <th style={{ width: '15%' }}>담당자</th>
                                        <th style={{ width: '15%' }}>상태</th>
                                        <th style={{ width: '15%' }}>기한</th>
                                        <th style={{ width: '15%' }}>진행도</th>
                                        <th className="text-right" style={{ width: '10%' }}>작업</th>
                                    </tr>
                                    </thead>
                                    <tbody style={{overflowX:"visible"}}>{renderProjectRows()}</tbody>
                                </Table>
                            </div>
