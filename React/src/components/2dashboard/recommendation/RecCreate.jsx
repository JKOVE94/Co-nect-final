...
import { Card, CardBody, CardHeader, CardTitle, Col, Container, Form, Row } from "react-bootstrap";
    ...
    return(
        ...
        <Row className="mx-0 align-items-start justify-content-center">
          <Col>
            <Card>
              <CardTitle
                style={{ display: "flex", margin:"1rem",justifyContent: "space-between" }}
              >
                <h2>건의사항 등록</h2>
              </CardTitle>
              <CardBody style={{ Height: "40em", overflowY: "auto" }}>
                <Form.Group>
                    ...
                    <Form.Control type="text" id="rec_title" 
                ...
                <Form.Group>
                    ...
                    <Form.Control as="textarea" id="rec_content"
